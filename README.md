...
- `test/pipelineops/governor_test.cljk` -- unit tests of governor hard
  checks, scope exclusion, and the self-trip regression test
- `test/pipelineops/advisor_test.cljk` -- advisor proposal shape and
  consistency
- `test/pipelineops/phase_test.cljk` -- rollout phase logic
- `test/pipelineops/governor_contract_test.cljk` -- full graph
  integration, audit trail
- `test/pipelineops/store_contract_test.cljk` -- Store protocol and
